...
class getDoctrine_FixturesLoadCommandService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'DataFixtures'.\DIRECTORY_SEPARATOR.'DomaineCategorieFixtures.php';
        ...
        $a->addFixtures([0 => ['fixture' => new \App\DataFixtures\AppFixtures(), 'groups' => []], 1 => ['fixture' => new \App\DataFixtures\DomaineCategorieFixtures(), 'groups' => []], 2 => ['fixture' => new \App\DataFixtures\EtatFixtures(), 'groups' => []], 3 => ['fixture' => new \App\DataFixtures\FicheFraisFixtures(), 'groups' => []], 4 => ['fixture' => new \App\DataFixtures\FraisForfaitFixtures(), 'groups' => []], 5 => ['fixture' => new \App\DataFixtures\LigneFraisForfaitFixtures(), 'groups' => []], 6 => ['fixture' => new \App\DataFixtures\LigneFraisHorsForfaitFixtures(), 'groups' => []], 7 => ['fixture' => new \App\DataFixtures\UtilisateurFixtures(), 'groups' => []]]);
